...
if __name__ == '__main__':
    ...
    all_keyphrases = set()
    for filepath in sorted(glob('patent/**', recursive=True)):
        print(filepath)
        ...
        with open(filepath,encoding='utf8') as f:
            ...
            for line_num, line in enumerate(f):       
                ...
                if (line_num % 1000 == 0):                
                    ...
                    with open('./log/patent/patent-entries-extracted.json', write_mode, encoding='utf-8') as f:
                        f.write(str(line_num)+'\n')
                        for elem in data_list:
                            json.dump(elem, f, indent=2)
                            f.write('\n')
                                    
                    with open('./log/patent/patent-keyphrases.json', 'w', encoding='utf-8') as f:
